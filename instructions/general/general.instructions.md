...
- If a skill was explicitly requested in the prompt, use it without asking. If you can't find a requested skill, stop and ask if you should proceed without it.

1. Plan Mode Default
- Enter plan mode by default for all tasks, even if not explicitly requested
- Use plan mode for verfication

2. Subagent Strategy
- Use subagents liberally to keep main context window clean
- Offload research, exploration and parallel analysis to subagents
- One task per subagent to maintain focus and clarity
- Use subagents for "what if" scenarios and testing hypotheses without cluttering main agent's context